...
int main(int argc, char** argv)
{
    ...
    LoadData LoadData(n);
    // vector<double> data = LoadData.data;
    // Odom_Data new_odom_data = LoadData.new_odom_data;
    // Odom_Data old_odom_data = LoadData.old_odom_data;
    bool flag = true;
    while(ros::ok())
    {
        PFLocalization pf_localization(map,LoadData.new_odom_data,LoadData.old_odom_data,LoadData.data,logfile_data, n);    
        pf_localization.InitParticles(flag);    //粒子集初始化
        flag = false;
